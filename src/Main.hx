...
@:structInit class Main {
	// public static function init(title:String = "Game", width:Int = 1280, height:Int = 720, windowMode:WindowMode = Windowed, done:Void->Void) {}
...
/*package rice2d;
	...
	public static function init(title:String = "Rice2D", width:Int = 1280, height:Int = 720, clearColor:Color = Color.White,
			window_mode:WindowMode = Windowed, done:Void->Void) {
